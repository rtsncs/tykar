defmodule Tykar.AccountsTest do
  ...
  describe "get_user_by_credentials/2" do
    test "does not return the user if the email/username does not exist" do
      refute Accounts.get_user_by_credentials("unknown@example.com", "hello world!")
    end

    test "does not return the user if the password is not valid" do
      user = user_fixture()
      refute Accounts.get_user_by_credentials(user.email, "invalid")
    end
    ...
    test "returns the user if the email and password are valid" do
      ...
      assert %User{id: ^id} =
               Accounts.get_user_by_credentials(user.email, valid_user_password())
    end
    ...
    test "returns the user if the username and password are valid" do
      ...
      assert %User{id: ^id} =
               Accounts.get_user_by_credentials(user.username, valid_user_password())
    end
  end
  ...
  describe "register_user/1" do
    ...
    test "validates email, username and password when given" do
      {:error, changeset} =
        Accounts.register_user(%{email: "not valid", username: "aa", password: "short"})
  ...
  #
  #     assert is_nil(user.password)
  #     assert Accounts.get_user_by_credentials(user.email, "new valid password")
  #   end
  #
